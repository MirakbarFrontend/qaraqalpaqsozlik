...
const GEMINI_API_KEY = process.env.AQ.Ab8RN6J_szJnEHIb7gMb8e7JMCgGpXO0AiQBKerVf1UQI55ixQ || '';
	...
	try {
		const r = await fetchFn(GEMINI_ENDPOINT, {
			...
			headers: {
				...
				'x-goog-api-key': AQ.Ab8RN6J_szJnEHIb7gMb8e7JMCgGpXO0AiQBKerVf1UQI55ixQ,
			},
...
app.get('/health', (req, res) => {
	res.json({
		ok: true,
		model: MODEL,
		hasKey: Boolean(AQ.Ab8RN6J_szJnEHIb7gMb8e7JMCgGpXO0AiQBKerVf1UQI55ixQ),
